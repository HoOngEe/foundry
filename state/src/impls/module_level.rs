...
mod tests {
    ...
    fn set_module_datum() {
        ...
        set_module_level_state!(state, [(key: key => datum_str: datum)]);
        check_module_level_state!(state, [(key: key => datum_str: datum)]);
    }
    ...
    fn checkpoint_and_revert() {
        ...
        set_module_level_state!(state, [
            (key: key1 => datum_str: datum)
        ]);
        check_module_level_state!(state, [
            (key: key1 => datum_str: datum)
        ]);
    ...
    fn checkpoint_discard_and_revert() {
        ...
        set_module_level_state!(state, [
            (key: key => datum_str: modified_datum_2)
        ]);
        check_module_level_state!(state, [
            (key: key => datum_str: modified_datum_2)
        ]);
